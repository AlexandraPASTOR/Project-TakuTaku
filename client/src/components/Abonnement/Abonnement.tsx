...
import PaymentPopUp from "../Login/PayementPopUp";
...
function Abonnement() {
  ...
  return (
    <>
      <section className="flex flex-col md:grid md:grid-cols-2 gap-10 md:gap-20 lg:gap-40 xl:gap-60 xxl:gap-80 max-w-4xl mx-6 md:mx-14 lg:mx-auto text-tertiary">
        {/* Offre Découverte */}
        <section className="border-5 border-secondary p-4 flex flex-col justify-between shadow-lg">
          <section>
            ...
            <section>
              ...
              <section className="flex justify-center mt-6 mb-3 font-semibold">
                {user?.abonnement_id === 1 ? (
                  ...
                  <button
                    ...
                    className={`mt-4  bg-secondary text-black py-1 px-7 lg:px-15 rounded-full cursor-pointer ${user?.abonnement_id === 1 ? "hidden" : "hover:scale-110 transition-transform duration-300"}`}
                  >
                    {user?.abonnement_id === 1
              ...
              <section className="flex justify-center mt-6 mb-3 font-semibold">
                {user?.abonnement_id === 2 ? (
                  ...
                  <button
                    ...
                    className={`mt-4 cursor-pointer bg-secondary text-primary py-1 px-7 lg:px-15 rounded-full hover:scale-110 transition-transform duration-300 ${user?.abonnement_id === 2 ? "hidden" : ""}`}
                  >
                    S'abonner
                  </button>
                )}
