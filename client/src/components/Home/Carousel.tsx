...
function Carousel() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url(${selectAnime[animeIndex]?.landscape})`,
      }}
    >
      ...
      <div className="relative z-10 pt-20">
        ...
        {selectAnime[animeIndex] && (
          <div className="relative z-10 text-center text-tertiary p-4">
            <h2 className="relative z-10 text-center text-[1.7rem] lg:text-3xl text-tertiary p-4 uppercase">
            ...
            <div className="text-tertiary px-4 lg:px-0">
              ...
              <div className="flex justify-center">
                <button
                  type="button"
                  className="bg-[var(--color-secondary)] my-3 text-[var(--color-primary)] py-1 px-4 rounded-full font-semibold text-lg hover:scale-110 transition-transform duration-300"
                >
                  <Link
                    to={`/anime/${selectAnime[animeIndex].id}`}
                  >
                    DÉTAILS
                  </Link>
                </button>
