      ...
      {showPayment ? (
        ...
        <section className="fixed inset-0 z-100 flex items-center justify-center bg-primary bg-opacity-70 px-4">
          <section className="relative bg-quadrary text-tertiary rounded-lg w-full max-w-lg p-8">
            ...
            <h2 className="text-2xl text-center mb-6 uppercase">
              Création de compte
            </h2>
            ...
            >
              ...
              <button
                type="submit"
                className="border border-tertiary/30 text-primary bg-secondary hover:scale-110 transition-transform duration-300 my-10 py-2 rounded-md w-full font-semibold mb-6 cursor-pointer"
              >
