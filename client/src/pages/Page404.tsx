...
function Page404() {
  return (
    <section className="flex flex-col items-center justify-center mt-20 md:mt-0">
      <h1 className="text-tertiary text-4xl md:text-5xl mt-16 text-center uppercase">
        404 - Page Not Found
      </h1>
      <img
        src="/404.png"
      ...
      <Link to="/">
        <button
          type="button"
          className="bg-[var(--color-secondary)] text-[var(--color-primary)] py-2 px-4 rounded-full font-medium cursor-pointer mt-8 text-sm md:text-base hover:scale-110 transition-transform duration-300"
        >
